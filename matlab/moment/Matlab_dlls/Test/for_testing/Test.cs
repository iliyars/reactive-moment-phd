...
* Date: Mon Feb  6 10:54:51 2023
* Arguments:
* "-B""macro_default""-W""dotnet:Matlab,Test,4.0,private,version=1.0""-T""link:lib""-d""C:
* \\
* \Matlab_dlls\Test\for_testing""-v""class{Test:C:\\
* \test.m}"
*/
using System;
...
namespace Matlab
{
  ...
  /// <summary>
  /// The Test class provides a CLS compliant, MWArray interface to the MATLAB functions
  /// contained in the files:
  /// <newpara></newpara>
  /// C:\Зеркало\Измерение момента\test.m
  /// </summary>
  /// <remarks>
  /// @Version 1.0
  /// </remarks>
  public class Test : IDisposable
  {
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray test(MWArray x)
    {
      return mcr.EvaluateFunction("test", x);
    }
    ...
    /// arguments.</returns>
    ///
    public MWArray[] test(int numArgsOut, MWArray x)
    {
      return mcr.EvaluateFunction(numArgsOut, "test", x);
    }
